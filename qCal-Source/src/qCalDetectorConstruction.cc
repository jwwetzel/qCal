...
////////////////////////////////////////////////////////////////////////////////////////////////
   G4VPhysicalVolume* XlayerOfDetector = new G4PVReplica(
         "detectorLayerX",                                                     //Name
...
////////////////////////////////////////////////////////////////////////////////////////////////
   G4VPhysicalVolume* XYlayerOfDetector = new G4PVReplica(
         "detecLayerXY",                                                           //Name
...
////////////////////////////////////////////////////////////////////////////////////////////////
   G4Box* solidAbsorber = new G4Box("SingleAbsorber", (cubeSize)*(p_nXAxis), (cubeSize)*(p_nYAxis), fAbsRadLen);
   G4Box* solidFinalAbsorber = new G4Box("FullAbs", (cubeSize)*(p_nXAxis), (cubeSize)*(p_nYAxis), (cubeSize+ fAbsRadLen)*(p_nZAxis));
   G4LogicalVolume* logicAbsorber = new G4LogicalVolume(solidAbsorber, absMat, "logicAbsorber");
   G4LogicalVolume* logicFinal = new G4LogicalVolume(solidFinalAbsorber, absMat, "logicFinal");
   G4ThreeVector absPos = G4ThreeVector(0, 0, (cubeSize)+fAbsRadLen - 0.001*cm);
...
////////////////////////////////////////////////////////////////////////////////////////////////
   G4VPhysicalVolume* XYZlayerOfDetector = new G4PVReplica(
         "detecLayerXYZ",                                                      //Name
...
G4VisAttributes* quartzAttributes = new G4VisAttributes(yellow);
logicQuartz->SetVisAttributes(quartzAttributes);
G4VisAttributes* SiPMAttributes = new G4VisAttributes(red);
logicSiPM->SetVisAttributes(SiPMAttributes);
G4VisAttributes* absAttributes = new G4VisAttributes(blue);
logicAbsorber->SetVisAttributes(absAttributes);
//worldLog->SetVisAttributes(new G4VisAttributes(true));
//logicQuartz->SetVisAttributes(new G4VisAttributes(true));
//logicSiPM->SetVisAttributes(new G4VisAttributes(true));
*/